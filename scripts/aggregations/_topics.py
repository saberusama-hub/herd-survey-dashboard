...
TOPICS: dict[str, str] = {
    ...
    "Neuroscience & brain":               r"\b(neuroscience|brain|neural|neuro(n|nal)|cognitive|cortex)\b",
    ...
    "Earth observation":                  r"\b(remote sensing|satellite (data|imagery)|earth observation|geospatial)\b",
